<x-layouts.app title="About Us - Master Tech & Life Skills">
    ...
    <section class="max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="mt-8 text-xl text-gray-700 leading-relaxed max-w-xl">
        ...
        <!-- Hero Visual -->
        <div class="relative">
            <div class="absolute inset-0 bg-gray-100/50 rounded-3xl blur-2xl"></div>
            <div class="relative rounded-3xl border border-gray-200 bg-gray-50 p-12">
                <div class="grid grid-cols-2 gap-6 text-center">
                    <div>
                        <div class="text-4xl font-bold text-gray-900">250K+</div>
                        <p class="text-gray-600 mt-2">Learners</p>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-gray-900">98%</div>
                        <p class="text-gray-600 mt-2">Completion Rate</p>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-gray-900">50+</div>
                        <p class="text-gray-600 mt-2">Training Centers</p>
                    </div>
                    <div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24">
        ...
        <p class="text-gray-600 text-xl max-w-3xl mb-16">
        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <!-- Tech Skills -->
            <div class="rounded-3xl border border-gray-200 bg-gray-50 p-10">
                <h3 class="text-2xl font-bold mb-6 text-gray-900">Technology & Digital Skills</h3>
                ...
                <div class="grid grid-cols-2 gap-4">
                    @foreach([
                        ...
                        <div class="px-5 py-3 rounded-xl bg-gray-100 border border-gray-200 text-gray-800">
                            {{ $skill }}
                        </div>
                    @endforeach
                </div>
            ...
            <!-- Life Skills -->
            <div class="rounded-3xl border border-gray-200 bg-gray-50 p-10">
                <h3 class="text-2xl font-bold mb-6 text-gray-900">Life & Professional Skills</h3>
    ...
    <section class="bg-gray-50 border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-3 gap-12 text-center">
            <div>
                <h4 class="text-xl font-bold mb-3 text-gray-900">Practical Learning</h4>
                <p class="text-gray-600">
                    Industry-aligned courses focused on real outcomes, not theory alone.
                </p>
            </div>
            <div>
                <h4 class="text-xl font-bold mb-3 text-gray-900">Flexible Delivery</h4>
                <p class="text-gray-600">
                    Learn online or in-person through our accredited training centers.
                </p>
            </div>
            <div>
                <h4 class="text-xl font-bold mb-3 text-gray-900">Career Impact</h4>
                <p class="text-gray-600">
