...
@if (session('user'))
    {{-- FULL SHARE DROPDOWN (Logged in users) --}}
...
@else
    {{-- SMALL SHARE COUNT CARD (Guests) --}}
    <div class="flex items-center space-x-2 bg-gray-100 border border-gray-200 px-5 py-3 rounded-full shadow-sm">
