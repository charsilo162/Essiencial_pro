<div x-data="{ open: @entangle('showModal') }"
    ...
    <div class="relative z-50 flex items-center justify-center min-h-screen px-4 text-center">
        ...
        <div class="inline-block w-full max-w-lg
                    bg-gradient-to-r from-[#6b1d2e] via-[#7a2a3a] to-[#8b3a2f]
                    p-[2px] rounded-xl shadow-2xl">

            <!-- Modal box -->
            <div class="bg-white rounded-xl text-left overflow-y-auto max-h-[90vh]">
                ...
                <form wire:submit.prevent="{{ $submitAction }}">
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-100">
                        ...
                        <button type="submit"
                            ...
                            class="relative px-5 py-2 rounded-lg
                                   bg-gradient-to-r from-[#6b1d2e] via-[#7a2a3a] to-[#8b3a2f]
                                   text-white font-semibold shadow-md
                                   hover:opacity-90 transition transform
                                   hover:scale-[1.02]
